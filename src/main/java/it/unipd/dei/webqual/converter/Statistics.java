...
public class Statistics {
  ...
  public static void stats(ImmutableGraph graph, ProgressLogger pl) {
    ...
    Counter missingItems = Metrics.missingItemsCounter(graph.basename().toString(), 0);
    Histogram degreesDist = Metrics.degreeHistogram(graph.basename().toString(), 0);
    ...
    CsvReporter reporter = CsvReporter.forRegistry(Metrics.registry)
